...
%                         sum_MIGD=sum_MIGD+MIGD_runNo.MIGD;
%                         MIGDs=[MIGDs,MIGD_runNo.MIGD];
%                         runNo = runNo + 1;
...
%                     Std=std(MIGDs);
%                     save([file,num2str(runNo),'.mat'],'CPS','Metric','MIGD','MIGD_means','MIGDs','Std');
                    MIGD=mean(Metric);
                    MIGDs=[MIGDs,MIGD];
                    MIGD_means=(sum_MIGD+MIGD)/runNo;
                    ...
                    Std=std(MIGDs,1);
                    save([file,num2str(runNo),'.mat'],'CPS','Metric','MIGD','MIGD_means','MIGDs','Std','Metric_HV','MHV','MHV_means','MHVs','Std_HV','igds','initPops','objs');
