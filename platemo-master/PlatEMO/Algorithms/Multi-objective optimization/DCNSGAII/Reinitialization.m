function [Population,FrontNo,CrowdDis] = Reinitialization(Problem,Population)
...
%--------------------------------------------------------------------------
    ...
    [Population,FrontNo,CrowdDis]   = EnvironmentalSelection([NewPop,Offsprings],length(Population));
